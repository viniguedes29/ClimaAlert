...
class WeatherHTMLTestCase(TestCase):
    ...
    def test_weather_page_without_data(self, mock_get):
        ...
        # Faz uma requisição GET para a view
        response = self.client.get(reverse("weather_by_city_name"), {"city_name": "Cidade Inexistente"})
        ...
        self.assertContains(response, "<p>Nenhuma informação disponível.</p>", html=True)
